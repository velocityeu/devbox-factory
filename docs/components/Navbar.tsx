    ...
    >
      <div className="max-w-6xl mx-auto px-5 flex items-center justify-between">
        ...
        <Link href="#" className="flex items-center gap-2.5 text-lg font-semibold tracking-tight">
          <span className="w-8 h-8 flex items-center justify-center rounded-lg bg-[var(--color-accent)] text-white text-sm">
            &#9889;
          </span>
      ...
      <div
        className={`
          ...
          bg-[var(--color-bg)] border-l border-[var(--color-border-light)]
          transform transition-transform duration-300 ease-apple md:hidden z-50
